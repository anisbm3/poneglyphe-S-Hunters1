...
public class FrontDebatController {
    ...
    private boolean champsSontValides() {
        return !animefield.getText().isEmpty() && !Descfield.getText().isEmpty() && !nomfield.getText().isEmpty();

    }

    public void OnClickAjouterDebat(ActionEvent actionEvent) {
        {

            if (champsSontValides()) {
                SD.ajouter(new Debat(animefield.getText(), Descfield.getText(), nomfield.getText()));
