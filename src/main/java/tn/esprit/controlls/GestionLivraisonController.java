...
public class GestionLivraisonController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("tn/esprit/GestionLivraison.fxml"));
      //  fillcomboProduit();

        livraisonCardLoader = new FXMLLoader(getClass().getResource("/tn/esprit/LivraisonCard.fxml"));
        loadLivraisonData();
