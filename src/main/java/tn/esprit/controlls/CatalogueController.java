...
public class CatalogueController implements Initializable {
    ...
    public void menuDisplayCard() {
        ...
        for (int q = 0; q < cardListData.size(); q++) {
            try {
                ...
                load.setLocation(getClass().getResource("/tn/esprit/CardPanier.fxml"));
    ...
    private ObservableList<Panier> getProductsFromDatabase() {
        ...
        try {
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/laugh-tale", "root", "");
