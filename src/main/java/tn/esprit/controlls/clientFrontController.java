...
import tn.esprit.utils.SendSMS;
...
//achref
@FXML
private Button AfficherDebatsBtn;

    @FXML
    private Button ajouterDebatBtn;


    @FXML
    private Button commentaireBtn;
    @FXML
    private Button afficherCommentairesBtn;
    ...
    void deconnecterButtonOnClick(ActionEvent event) {
        loggedInUser = null;
        serviceusers.changeScreen(event, "/tn/esprit/login.fxml", "LOGIN");
    }
    ...
    private void verifierEmailOnClick(ActionEvent event) throws SQLException {
        ...
        serviceusers.changeScreen(event, "/tn/esprit/motDePasseOublie.fxml", "Vérifier le code");
        sendMail(event, Rand, loggedInUser);
    }

//balsem
    @FXML
    void onAjouterReservationClicked(ActionEvent event) {
        System.out.println(loggedInUser);
        serviceusers.changeScreen(event, "/tn/esprit/ajouterResevation.fxml", "ajout des reservations");
    ...
    @FXML
    void onAfficherEventClicked(ActionEvent event) {
        System.out.println(loggedInUser);
        serviceusers.changeScreen(event, "/tn/esprit/FrontEvent.fxml", "les evements existant");


    }
    @FXML
    void OnClickedReservations(ActionEvent event) {

        System.out.println(loggedInUser);
        serviceusers.changeScreen(event, "/tn/esprit/ReservationAfficher.fxml", "mes reservations");
    ...
    //achref
    @FXML
    void onClickedDebatAjouter(ActionEvent event) {

        System.out.println(loggedInUser);
        serviceusers.changeScreen(event, "/tn/esprit/AjouterDebats.fxml", "ajout des debats");
    }


    @FXML
    void onAfficherDebatsClicked(ActionEvent event) {
        System.out.println(loggedInUser);
        serviceusers.changeScreen(event, "/tn/esprit/AfficherDebats.fxml", "afficher des debats");
    }



    @FXML
    void onClickedAjouterCommentaire(ActionEvent event) {
        System.out.println(loggedInUser);
        serviceusers.changeScreen(event, "/tn/esprit/AjouterCommentaires.fxml", "ajouter des commentaires");
    }
