...
public class AfficherController implements Initializable {
    ...
    void AjouterProduit(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/AddProduit.fxml"));
    ...
    void AffPanier(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/Paniers.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            stage.show();
   ...
   /* @FXML
    ...
    private void openDetailsPage(Produit produit) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/Produit.fxml"));
            Parent root = fxmlLoader.load();
            Card1Controller controller = fxmlLoader.getController();
            if (controller != null) {
