...
public class login_controller {
            ...
            if (!ps.userLoggedIn(pseudoLogin.getText(), encryptor.encryptString(mdpLogin.getText()))) {
                ...
                switch (utilisateur.getRole()){
                    case "Admin":
                        ...
                        ps.changeScreen(event, "/tn/esprit/dashboard.fxml", "Admin");
                        break;
                    case "Utilisateur":
                        clientFrontController.setLoggedInUser(utilisateur);
                        ps.changeScreen(event, "/tn/esprit/clientFront.fxml", "Admin");
                        break;
                    case "Livreur":
                        break;
                }
    ...
    private void signinLoginButtonOnClick(ActionEvent event){
        ps.changeScreen(event, "/tn/esprit/signUp.fxml", "Sign Up");
    }
    @FXML
    private void mdpOublieOnClick(ActionEvent event){
        ...
        try {
            ...
            ps.changeScreen(event, "/tn/esprit/motDePasseOublie.fxml", "Vérifier le code");
        } catch (SQLException e) {
            ...
            if (newLocation != null && newLocation.startsWith("http://localhost")) {
                ...
                if (code != null) {
                    try {
                        ...
                        stage.close();
                        ps.changeScreen(event, "/tn/esprit/clientFront.fxml", "XTRATIME");
