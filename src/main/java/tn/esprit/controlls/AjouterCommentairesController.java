...
private Button ajouterbtn;
    ...
    void onClickedAjouter(ActionEvent event) throws SQLException {
        ...
        if (nomMES.getText().isEmpty() ||  nomDebat.getValue() == null || clientFrontController.loggedInUser.getPseudo() == null) {
      ...
      //  Commentaire commentaire = new Commentaire(nomMES.getText(), nomDebat.getValue(), clientFrontController.loggedInUser.getPseudo());
        Commentaire commentaire = new Commentaire(nomMES.getText(),nomDebat.getValue(),clientFrontController.loggedInUser.getPseudo());
        System.out.println(commentaire);
        SC.ajouter(commentaire);

        // Afficher une notification de succès
        afficherNotification("Ajout avec succès", "Le commentaire a été ajouté avec succès.");
    }
    ...
    void onAfficherClicked(ActionEvent event) {
        ...
        try{   FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/AfficherCommentaires.fxml"));
