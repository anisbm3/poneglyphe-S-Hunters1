...
public class AjouterFactureController {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        loader = new FXMLLoader(getClass().getResource("/tn/esprit/AjouterFacture.fxml"));
    ...
    private void Acceuil(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("/tn/esprit/GestionFacture.fxml"));
