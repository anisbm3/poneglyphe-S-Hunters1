...
import tn.esprit.models.ExcelExporter;
import tn.esprit.models.Rating;
import tn.esprit.services.ServiceDebat;
import tn.esprit.services.ServiceRating;
...
public class BackDebatsController {
   ...
   @FXML
    ...
    private void refreshDebat() throws SQLException {
        ...
        for (Debat debat : debats) {
            ...
            eventLabel.setOnMouseClicked(event -> {
                ...
                animefield.setText(debat.getSujet_Debat());
                rate=0;
                star2.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
                star3.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
                star4.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
                star5.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
                star1.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
            });
...
String filePath = "path_to_your_excel_file.xlsx"; // Provide the file path here
    ...
    void rate1(MouseEvent event) {
        ...
        star4.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star5.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star1.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
    ...
    void rate2(MouseEvent event) {
        rate=2;
        star2.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star3.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star4.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star5.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star1.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
    ...
    void rate3(MouseEvent event) {
        rate=3;
        star2.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star3.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star4.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star5.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star1.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
    }
    ...
    void rate4(MouseEvent event) {
        ...
        star2.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star3.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star4.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star5.setImage(new Image(getClass().getResource("/tn/esprit/img/empty_star.png").toString()));
        star1.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
    }
    ...
    void rate5(MouseEvent event) {
        ...
        star3.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star4.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star5.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
        star1.setImage(new Image(getClass().getResource("/tn/esprit/img/star.png").toString()));
    }
    @FXML
    public void Rating( MouseEvent event) throws SQLException {
        ...
        rating.setID_User(clientFrontController.loggedInUser.getPseudo());
    ...
    void OnClickedBack(ActionEvent event) {
        serviceUtilisateurs.changeScreen(event, "/tn/esprit/dashboard.fxml", "client front");
