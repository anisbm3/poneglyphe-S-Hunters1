...
public  class ServicePanier implements IService<Panier> {
    ...
    public void ajouter(Panier Panier) throws SQLException {
        String req = "insert into Panier (IDU,  IDPRO, Numcmd) " +
                "values ('" + Panier.getIDU() + "','" + Panier.getIDPRO() + "','" + Panier.getNumcmd() + "' )";
    ...
    public void modifier(Panier Panier) throws SQLException {
        String req = "update Panier set IDU=?, IDPRO=?, Numcmd=? where IDP=?";
        PreparedStatement pre = connection.prepareStatement(req);
        pre.setInt(1, Panier.getIDU());
        pre.setInt(2, Panier.getIDPRO());
        pre.setInt(3, Panier.getNumcmd());
        pre.setInt(4, Panier.getIDP());
        pre.executeUpdate();
    }
    ...
    public List<Panier> afficher() throws SQLException {
        ...
        while (res.next()) {
            ...
            pa.setIDPRO(res.getInt(3));
            pa.setNumcmd(res.getInt(4));
